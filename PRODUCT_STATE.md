...
| Steam Lobby (Friends/Invite/Join Game) | Code-complete for same-region create/browse/join/invite, with callsign/loadout/ready-up fixes and client host-state synchronization now tested. Cross-region discovery remains blocked by the installed `steamworks.js` binding's missing distance filter; real two-account Steam acceptance is still open. See `docs/steam-lobby-integration-plan-2026-08-20.md` and `docs/multiplayer-host-assignment-review-2026-08-20.md` |
...
| Current milestone | Sprint 28 convergence: finish Depth Contract, prove the relic/combat hooks in one expedition, then run real packaged/two-account acceptance — see `docs/sprint28plan.md` and `docs/re-entry-review-and-game-plan-2026-08-20.md` |
