...
export const SHOWROOM_CATEGORIES = Object.freeze({
    // Kenney modular kits, restyled to the game palette. Exhibited so the
    // museum coverage guard stays meaningful -- a registered model nobody can
    // look at is a model nobody notices is broken.
    KIT_SPACE: [
        'kit_space_cables',
        'kit_space_corridor',
        'kit_space_corridor_corner',
        'kit_space_corridor_end',
        'kit_space_corridor_intersection',
        'kit_space_corridor_junction',
        'kit_space_corridor_transition',
        'kit_space_corridor_wide',
        'kit_space_corridor_wide_corner',
        'kit_space_corridor_wide_end',
        'kit_space_corridor_wide_intersection',
        'kit_space_corridor_wide_junction',
        'kit_space_gate',
        'kit_space_gate_door',
        'kit_space_gate_door_window',
        'kit_space_gate_lasers',
        'kit_space_room_corner',
        'kit_space_room_large',
        'kit_space_room_large_variation',
        'kit_space_room_small',
        'kit_space_room_small_variation',
        'kit_space_room_wide',
        'kit_space_room_wide_variation',
        'kit_space_stairs',
        'kit_space_stairs_wide',
        'kit_space_template_corner',
        'kit_space_template_detail',
        'kit_space_template_floor',
        'kit_space_template_floor_big',
        'kit_space_template_floor_detail',
        'kit_space_template_floor_detail_a',
        'kit_space_template_floor_layer',
        'kit_space_template_floor_layer_hole',
        'kit_space_template_floor_layer_raised',
        'kit_space_template_wall',
        'kit_space_template_wall_corner',
        'kit_space_template_wall_detail_a',
        'kit_space_template_wall_half',
        'kit_space_template_wall_stairs',
        'kit_space_template_wall_top',
    ],
    KIT_CAVE: [
        'kit_cave_corridor',
        'kit_cave_corridor_corner',
        'kit_cave_corridor_end',
        'kit_cave_corridor_intersection',
        'kit_cave_corridor_junction',
        'kit_cave_corridor_transition',
        'kit_cave_corridor_wide',
        'kit_cave_corridor_wide_corner',
        'kit_cave_corridor_wide_end',
        'kit_cave_corridor_wide_intersection',
        'kit_cave_corridor_wide_junction',
        'kit_cave_gate',
        'kit_cave_gate_metal_bars',
        'kit_cave_gate_overhang',
        'kit_cave_gate_rock',
        'kit_cave_ladder',
        'kit_cave_room_corner',
        'kit_cave_room_large',
        'kit_cave_room_large_variation',
        'kit_cave_room_small',
        'kit_cave_room_small_variation',
        'kit_cave_room_wide',
        'kit_cave_room_wide_variation',
        'kit_cave_stairs',
        'kit_cave_stairs_wide',
        'kit_cave_template_corner',
        'kit_cave_template_detail',
        'kit_cave_template_floor',
        'kit_cave_template_floor_big',
        'kit_cave_template_floor_detail',
        'kit_cave_template_floor_detail_a',
        'kit_cave_template_floor_layer',
        'kit_cave_template_floor_layer_hole',
        'kit_cave_template_floor_layer_raised',
        'kit_cave_template_wall',
        'kit_cave_template_wall_corner',
        'kit_cave_template_wall_detail_a',
        'kit_cave_template_wall_half',
        'kit_cave_template_wall_stairs',
        'kit_cave_template_wall_top',
    ],
    TACTICAL_PROPS: [
        'base_console',
        'o2_generator',
...
export async function buildShowroomScene(threeGame) {
    ...
    const allItems = [
        ...
        ...SHOWROOM_CATEGORIES.ARCHITECTURE_3D.map((id) => ({ id, type: 'prop', category: 'ARCHITECTURE' })),
        ...SHOWROOM_CATEGORIES.FIXTURES_3D.map((id) => ({ id, type: 'prop', category: 'FIXTURES' })),
        ...SHOWROOM_CATEGORIES.SETPIECES.map((id) => ({ id, type: 'prop', category: 'SETPIECE' })),
        ...SHOWROOM_CATEGORIES.KIT_SPACE.map((id) => ({ id, type: 'prop', category: 'KIT_SPACE' })),
        ...SHOWROOM_CATEGORIES.KIT_CAVE.map((id) => ({ id, type: 'prop', category: 'KIT_CAVE' })),
