export const ROOM_THEME_CATALOG = Object.freeze([
    ...
    },
    {
        ...
        doorStyle: 'utility',
        signatureProps: ['prop_conduit_hub'],
        largeProps: ['prop_cyber_junction'],
        smallProps: ['scatter_cable_coil', 'scatter_bolts'],
    ...
    },
    {
        ...
        largeProps: ['prop_bunker_supplies'],
    ...
    },
    {
        ...
        doorStyle: 'security',
        signatureProps: ['prop_cyber_junction'],
        largeProps: ['prop_bunker_supplies'],
        smallProps: ['scatter_bolts'],
    ...
    },
    {
        ...
        doorStyle: 'cryo',
        signatureProps: ['prop_cave_lichen'],
        largeProps: ['prop_bunker_supplies', 'prop_specimen_tank'],
    ...
    },
    {
        ...
        doorStyle: 'resin',
        signatureProps: ['prop_spore_colony'],
        largeProps: ['prop_hive_resin_sac'],
    ...
    },
    {
        ...
        floorStyle: 'bio-hive',
        doorStyle: 'hive',
        signatureProps: ['prop_cave_eggs_intact'],
        largeProps: ['prop_hive_resin_sac', 'prop_cave_hive_wounded'],
