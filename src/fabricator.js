...
export const FAB_RECIPES = Object.freeze([
    ...
    { id: 'exo_plating', name: 'THERMAL HEAT EXCHANGER', klass: 'MODULE', output: { kind: 'mod', itemdefid: 4144 }, rarity: 'LEGENDARY', art: '/schematics/schematic_07.webp', cost: { tech: 22, coin: 16, med: 6 }, printSeconds: 20, blurb: 'Shortens the live shield recharge delay.' },
