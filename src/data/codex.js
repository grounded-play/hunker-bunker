...
export const CODEX_ENTRIES = Object.freeze([
    ...
    { id: 'wreckage_scout_tracking', name: 'SCOUT ALPHA BLACK PAYLOAD', category: 'INFRASTRUCTURE',
      blurb: 'The Scout hull carried the tracker. Rescue was never the cleanest word for the operation.' },
    { id: 'wreckage_engineer_relay', name: 'BRAVO ENGINEER RELAY', category: 'INFRASTRUCTURE',
      blurb: 'The Engineer hull carried the repeater. Someone wanted the signal amplified from inside the ice.' },
    { id: 'wreckage_tank_weapon', name: 'CHARLIE TANK CONTAINMENT WEAPON', category: 'INFRASTRUCTURE',
    ...
    { id: 'specimen_0047', name: 'SPECIMEN 0047', category: 'PHENOMENON',
