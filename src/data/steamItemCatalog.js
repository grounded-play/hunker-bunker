...
// Item names and descriptions are player-visible in the Armory, the Steam
// Vault and every reward toast, so they are rebuilt in place on locale change
// like the other content catalogs. Everything else in an entry is an
// identifier, a price flag or an asset URL and must never be translated.
export const STEAM_ITEM_CATALOG = localizeCatalog('narrative.steamItems', Object.freeze(catalog), {
    skip: ['itemdefid', 'rarity', 'tradable', 'marketable', 'img', 'localImg', 'localImgLarge']
});
