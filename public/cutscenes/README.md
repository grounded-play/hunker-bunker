...
- `scout-class-intro.webm`
- `tank-class-intro.webm`
- `engineer-class-intro.webm`
- `scout-intro.webm`
- `tank-intro.webm`
- `engineer-intro.webm`
...
- `scout-class-intro.mp4` / `scout-class-intro-poster.jpg`
- `tank-class-intro.mp4` / `tank-class-intro-poster.jpg`
- `engineer-class-intro.mp4` / `engineer-class-intro-poster.jpg`
- `scout-intro.mp4` / `scout-intro-poster.jpg`
- `tank-intro.mp4` / `tank-intro-poster.jpg`
- `engineer-intro.mp4` / `engineer-intro-poster.jpg`
