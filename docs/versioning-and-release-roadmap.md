...
**Current Working Version:** `v2.4.5-beta` (`2.4.5-beta` in `package.json`, branch `dev/sprint-41`)
...
| **v2.4.5-beta (Active)** | Sprint 41 (`dev/sprint-41`) | *In progress* | Active development branch | Architecture kit GLB routing, faction prop placement, theme matrix holes, Visual Overhaul Phase B (normal/roughness maps), multi-chunk setpieces, and debug tool code splitting. |
