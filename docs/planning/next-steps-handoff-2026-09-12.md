...
foundation, first metric structure-shell loader, and pure WorldPlan setpiece
claim allocation are now landed (`f51f904`, `b8bddcd`, `b80d2cd`, `e068bcd`).
Six QA worlds are lazy-loaded (`76ef3c7`); the always-on
...
acceptance before bulk content authoring. The Ring 1 reactor-vent objective now
also has a dedicated authored room (`76cd8df`).
