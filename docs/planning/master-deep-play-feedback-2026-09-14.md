...
- The Settings/header/dev-console Unlock All path now has parity with the Armory control: in addition to all 153 catalogued skins, chassis, decals, charms, modules, HUDs, VFX/tracers and voice banks, it unlocks all standalone operator polishes and all weapon sheens. Its result text reports the catalog audit instead of the obsolete “weapon & chassis skins” claim.
