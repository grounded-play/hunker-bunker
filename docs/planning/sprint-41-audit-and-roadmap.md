...
- [x] [MIGRATED] **Sprint 41.6**: Execute physical hardware and two-account Steam acceptance testing. <!-- Migrated to master backlog: docs/planning/todo-audit-backlog-and-conflicts-2026-09-24.md#true-todos -->
