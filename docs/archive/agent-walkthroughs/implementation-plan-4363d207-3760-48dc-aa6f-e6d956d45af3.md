...
## Current Asset & Catalog Status Matrix
...
## Asset Compliance Pipeline & Target Formats
...
## Proposed Asset Generation & Production Batches
...
1. **Automated Conversion Pipeline (`scripts/process-season-assets.py`):**
   - Write a helper script using PIL and ImageMagick to take generated raw images and format them into the exact 4-file compliant set (`256px local`, `512px large`, `1254px master`, `1254px chroma`).
2. **Schema Update:**
