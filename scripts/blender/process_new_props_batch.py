#!/usr/bin/env python3
"""Batch processing script for the 20 newly added props:
- Decimates geometry to ~1,400 polygons
- Resizes PBR textures to max 192x192 JPEG
- Centers XY and grounds Z
- Exports optimized runtime GLBs to public/3d/runtime/new3ds/ (~80-120 KB each)
...
GLB_FILES = [
    'prop_chair_operator_wrecked.glb',
    'prop_conduit_junction_box.glb',
    'prop_flesh_steel_coffin.glb',
    'prop_flesh_steel_cradle.glb',
    'prop_flesh_steel_inhaler.glb',
    'prop_fungal_mycelium_loom.glb',
    'prop_fungal_resin_basin.glb',
    'prop_fungal_spore_dispenser.glb',
    'prop_fungal_tendril_altar.glb',
    'prop_icey_frost_manifold.glb',
    'prop_icey_frost_vent.glb',
    'prop_icey_thermal_pod.glb',
    'prop_light_cluster_dripping.glb',
    'prop_locker_bulged.glb',
    'prop_pipe_rupture.glb',
    'prop_shrine_plinth_broken.glb',
    'prop_storage_drum_dented.glb',
    'prop_terminal_ruptured.glb',
    'prop_valve_wheel_fused.glb',
    'prop_vent_grate_exploded.glb'
]
